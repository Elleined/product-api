...
class RegularSellerRestrictionImplTest {
    ...
    @InjectMocks
    private RegularSellerRestrictionImpl regularSellerRestriction;
    ...
    void isExceedsToMaxListingPerDay() {
        ...
        // Calling the method
        // Assestions
        assertTrue(regularSellerRestriction.isExceedsToMaxListingPerDay(user));
    ...
    void isExceedsToMaxRejectionPerDay() {
        ...
        // Calling the method
        // Assestions
        assertTrue(regularSellerRestriction.isExceedsToMaxRejectionPerDay(user), "Failing because the orders not exceeds to " + RegularSellerRestriction.MAX_ORDER_REJECTION_PER_DAY);
    ...
    void isExceedsToMaxAcceptedOrder() {
        ...
        // Calling the method
        // Assestions
        assertTrue(regularSellerRestriction.isExceedsToMaxAcceptedOrder(user), "Failing because total orders should exceeds to " + RegularSellerRestriction.MAX_ACCEPTED_ORDER);
    ...
    void isExceedsToMaxPendingOrder() {
        ...
        // Calling the method
        // Assestions
        assertTrue(regularSellerRestriction.isExceedsToMaxPendingOrder(user), "Failing because total orders should exceeds to " + RegularSellerRestriction.MAX_PENDING_ORDER);
