...
public final class UtUtils {
    ...
    public static void setField(Object object, String fieldClassName, String fieldName, Object fieldValue) throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException, IllegalAccessException, java.lang.reflect.InvocationTargetException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields132689564491000 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields132689564491000.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass132689564505199 = (java.lang.reflect.Field[]) methodForGetDeclaredFields132689564491000.invoke(java.lang.reflect.Field.class, false);
        modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass132689564505199).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static void setStaticField(Class<?> clazz, String fieldName, Object fieldValue) throws NoSuchFieldException, IllegalAccessException {
        ...
        try {
            ...
            java.lang.reflect.Method methodForGetDeclaredFields132689568255500 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
            methodForGetDeclaredFields132689568255500.setAccessible(true);
            java.lang.reflect.Field[] allFieldsFromFieldClass132689568258699 = (java.lang.reflect.Field[]) methodForGetDeclaredFields132689568255500.invoke(java.lang.reflect.Field.class, false);
            modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass132689568258699).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static Object getFieldValue(Object obj, String fieldClassName, String fieldName) throws ClassNotFoundException, NoSuchMethodException, java.lang.reflect.InvocationTargetException, IllegalAccessException, NoSuchFieldException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields132689573443100 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields132689573443100.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass132689573445499 = (java.lang.reflect.Field[]) methodForGetDeclaredFields132689573443100.invoke(java.lang.reflect.Field.class, false);
        modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass132689573445499).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static Object getStaticFieldValue(Class<?> clazz, String fieldName) throws IllegalAccessException, NoSuchFieldException {
        ...
        do {
            try {
                ...
                java.lang.reflect.Method methodForGetDeclaredFields132689577611599 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
                methodForGetDeclaredFields132689577611599.setAccessible(true);
                java.lang.reflect.Field[] allFieldsFromFieldClass132689577617200 = (java.lang.reflect.Field[]) methodForGetDeclaredFields132689577611599.invoke(java.lang.reflect.Field.class, false);
                modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass132689577617200).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    private static java.lang.invoke.MethodHandles.Lookup getLookupIn(Class<?> clazz) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, java.lang.reflect.InvocationTargetException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields132689612896600 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields132689612896600.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass132689612901599 = (java.lang.reflect.Field[]) methodForGetDeclaredFields132689612896600.invoke(java.lang.invoke.MethodHandles.Lookup.class, false);
        allowedModes = java.util.Arrays.stream(allFieldsFromFieldClass132689612901599).filter(field1 -> field1.getName().equals("allowedModes")).findFirst().get();


        java.lang.reflect.Method methodForGetDeclaredFields132689612922100 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields132689612922100.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass132689612923600 = (java.lang.reflect.Field[]) methodForGetDeclaredFields132689612922100.invoke(java.lang.invoke.MethodHandles.Lookup.class, false);
        allModesField = java.util.Arrays.stream(allFieldsFromFieldClass132689612923600).filter(field1 -> field1.getName().equals("ALL_MODES")).findFirst().get();
