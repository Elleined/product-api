...
public class SaleRetailProductRequest extends SaleProductRequest {
    ...
    public SaleRetailProductRequest(@Positive(message = "Sale percentage cannot be 0 or less than 0") @Size(max = 100, message = "Sale percentage must be in range of 1 - 100 only") int salePercentage, double pricePerUnit, int quantityPerUnit) {
