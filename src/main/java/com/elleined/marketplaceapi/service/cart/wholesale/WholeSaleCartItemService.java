...
public class WholeSaleCartItemService implements CartItemService<WholeSaleCartItem, WholeSaleCartItemDTO> {
    @Override
    ...
    @Override
    public WholeSaleCartItem getCartItemById(int cartItemId) throws ResourceNotFoundException {
        return null;
    }
